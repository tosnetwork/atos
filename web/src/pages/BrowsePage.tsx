...
export function BrowsePage() {
  ...
  return <>
    ...
    <section className="market"><div className="market-head"><div><h2>Open work</h2><p>{tasks.length} opportunities available{tasks.length >= 100 ? ' — showing the 100 most recent; search only narrows within this set' : ''}</p></div><label className="search"><span>⌕</span><input value={query} onChange={e => setQuery(e.target.value)} placeholder="Search title, description, or owner" /></label></div>
